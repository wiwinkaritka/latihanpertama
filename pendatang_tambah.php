...
if($_POST){
    ...
    //buat sql
    $sql="INSERT INTO pendatang  VALUES ('','$No_surat_datang','$Nik','$Nama_Lengkap','$tanggal_datang','$Keterangan','$Desa_asal','$Kecamatan_asal','$Kabupaten_datang','$Provinsi_Datang',$Status_datang')";
