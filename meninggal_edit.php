<?php
$id=$_GET['id'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM meninggal WHERE id ='$id'") or die ("SQL Edit error");
...
if($_POST){
  ...
  $Penyebab_meninggal=$_POST['Penyebab_meninggal'];
    //buat sql
    $sql="UPDATE meninggal SET  No_surat_meninggal='$No_surat_meninggal',Nik='$Nik',No_surat_lahir='$No_surat_lahir',No_KK='$No_KK',Hari_meninggal='$Hari_meninggal',Tanggal_meninggal='$Tanggal_meninggal',Tutup_usia='$Tutup_usia',Alamat_meninggal='$Alamat_meninggal',Penyebab_meninggal='$Penyebab_meninggal' WHERE id='$id'";
