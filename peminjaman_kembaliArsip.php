<?php
$nope=$_GET['nope'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE No_KK ='$nope'") or die ("SQL Edit error");
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
								<input type="text" name="No_KK" value="<?=$data['No_KK']?>" class="form-control" id="inputEmail3" placeholder="No_KK" readonly="true">
                            </div>
                        </div>
